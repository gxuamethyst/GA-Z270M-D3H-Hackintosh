...
>
> this EFI can not get OTA update(macOS 14.xxx --> macOS 14.XXX) from Settings, please download full macOS package and full reinstall from it.
...
* Version **1.0.0**, you can download the latest version from [OpenCorePkg](https://github.com/acidanthera/OpenCorePkg/releases).
